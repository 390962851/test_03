...
const goodsRule = {path: '/goods_list', component: () => import('@/components/goods/GoodsCate.vue')};
const categoryRule = {path: '/goods_categories', component: () => import('@/components/goods/GoodsList.vue')};

const home = {name: '/home', path: '/home', meta: {title: '主页', model: '数据展示'}, component: () => import('@/view/home')}; //主页
const regularAssets = {path: '/regularAssets', name: 'regularAssets', meta: {title: '资产管理',model: '固定资产'}, component: () => import('@/view/regular_assets')}; ///固定资产
const invisibleAssets = {path: '/invisibleAssets', name: 'invisibleAssets', meta: {title: '资产管理',model: '无形资产'}, component: () => import('@/view/invisible_assets')}; ///无形资产
const consumables = {path: '/consumables', name: 'consumables', meta: {title: '资产管理', model: '易耗品'}, component: () => import('@/view/consumables')}; ///易耗品
