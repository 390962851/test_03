<template>
  <div>
    <a-modal v-model="showM" title="添加信息" on-ok="handleOk" :width="'45%'">
          ...
          <a-row :gutter="8">
            ...
            <a-col :span="12">
              <a-form-model-item label="资产原值" prop="assetsValue">
                <a-input-number v-model="form.assetsValue" @blur="onChangeAssetsValue(form.assetsValue)" :formatter="value => `$ ${value}`.replace(/\B(?=(\d{3})+(?!\d))/g, ',')"
